        ...
        >
          <div className="px-4 sm:px-8 py-4 sm:py-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 mt-4">
              <div className={`p-3 sm:p-4 rounded-xl ${isDark ? "bg-slate-800/50 border border-slate-700" : "bg-white border border-gray-200 shadow-sm"}`}>
                <p className={`text-xs sm:text-sm ${isDark ? "text-slate-400" : "text-gray-500"}`}>Clocked In</p>
                <p className={`text-xl sm:text-2xl font-bold ${isDark ? "text-green-400" : "text-green-600"}`}>
                  {clockedInCount}
                </p>
              </div>
              <div className={`p-3 sm:p-4 rounded-xl ${isDark ? "bg-slate-800/50 border border-slate-700" : "bg-white border border-gray-200 shadow-sm"}`}>
                <p className={`text-xs sm:text-sm ${isDark ? "text-slate-400" : "text-gray-500"}`}>On Break</p>
                <p className={`text-xl sm:text-2xl font-bold ${isDark ? "text-amber-400" : "text-amber-600"}`}>
                  {onBreakCount}
                </p>
              </div>
              <div className={`p-3 sm:p-4 rounded-xl ${isDark ? "bg-slate-800/50 border border-slate-700" : "bg-white border border-gray-200 shadow-sm"}`}>
                <p className={`text-xs sm:text-sm ${isDark ? "text-slate-400" : "text-gray-500"}`}>Total Hours</p>
                <p className={`text-xl sm:text-2xl font-bold ${isDark ? "text-cyan-400" : "text-blue-600"}`}>
                  {totalHoursToday.toFixed(1)}
                </p>
              </div>
              <div className={`p-3 sm:p-4 rounded-xl ${isDark ? "bg-slate-800/50 border border-slate-700" : "bg-white border border-gray-200 shadow-sm"}`}>
                <p className={`text-xs sm:text-sm ${isDark ? "text-slate-400" : "text-gray-500"}`}>Pending Corrections</p>
                <p className={`text-xl sm:text-2xl font-bold ${pendingCount > 0 ? (isDark ? "text-red-400" : "text-red-600") : (isDark ? "text-slate-400" : "text-gray-600")}`}>
                  {pendingCount}
                </p>
              </div>
            </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className={`text-sm ${isDark ? "text-slate-400" : "text-gray-500"}`}>
                            {clock.position} - {clock.department}
                          </p>
                        </div>
                        <span
                        ...
                        >
                          {clock.status === "on_break" ? "On Break" : "Working"}
                        </span>
                      </div>
                      <div className={`mt-3 pt-3 border-t ${isDark ? "border-slate-700" : "border-gray-200"}`}>
                        ...
                        <div className="flex justify-between text-sm mt-1">
                          ...
                          <span className={`font-medium ${isDark ? "text-cyan-400" : "text-blue-600"}`}>
                            {formatDuration(clock.hoursWorked)}
                          </span>
                        </div>
                      </div>
                      <button
                        onClick={() => handleForceClockOut(clock.personnelId)}
