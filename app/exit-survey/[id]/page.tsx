      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-4">
            This exit survey has already been submitted. Thank you for your feedback!
          </p>
          <p className="text-sm text-gray-500">
            If you believe this is an error or need to update your responses, please contact HR.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Survey Declined</h1>
          <p className="text-gray-600">
            This exit survey was marked as declined. If you&apos;d like to provide feedback, please contact HR to reopen it.
          </p>
        </div>
      </div>
    );
